...
Stock<size>::Stock(const std::string& stockID, std::array<float, size>& topCurPrice_B, std::array<float, size>& topCurPrice_S,
...
int main() {
	...
	Stock<3> stock(stockID, topCurPrice_B, topCurPrice_S, topCurVol_B, topCurVol_S, totalvol);
}